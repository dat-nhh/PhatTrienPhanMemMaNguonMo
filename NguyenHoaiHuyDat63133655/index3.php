...
<form action="" name="tienKaraoke" method="post">
    <table align="center" style="background-color: bisque">
        <tr>
            <td style="background-color: red; color: yellow; text-align: center" colspan="3"><h4>TÍNH TIỀN KARAOKE</h4></td>
        </tr>
        <tr>
            <td>Giờ bắt đầu:</td>
        ...
        <tr>
            ...
            <td colspan><input type="text" name="tien" size="9" readonly value="<?php if (isset($tien)) echo $tien; else echo ''; ?>" style="background-color: lightpink"></td>
            <td>(VNĐ)</td>
        </tr>
        <tr>
